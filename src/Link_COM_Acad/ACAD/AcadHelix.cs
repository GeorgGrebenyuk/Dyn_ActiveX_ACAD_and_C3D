namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadHelix _i;
		internal AcadHelix(object AcadHelix_object) 
		{
			this._i = AcadHelix_object as AXDBLib.IAcadHelix;
		...
		///
		///</summary>
		public void Set_Constrain(AXDBLib.AcHelixConstrainType constrainType) 
		{
		...
		///
		///</summary>
		public void Set_Twist(AXDBLib.AcHelixTwistType twistType) 
		{
