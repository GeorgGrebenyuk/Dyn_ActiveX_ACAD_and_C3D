namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadSpline _i;
		internal AcadSpline(object AcadSpline_object) 
		{
			this._i = AcadSpline_object as AXDBLib.IAcadSpline;
		...
		///
		///</summary>
		public void Set_KnotParameterization(AXDBLib.AcSplineKnotParameterizationType knotParamVal) 
		{
		...
		///
		///</summary>
		public void Set_SplineFrame(AXDBLib.AcSplineFrameType show) 
		{
		...
		///
		///</summary>
		public void Set_SplineMethod(AXDBLib.AcSplineMethodType method) 
		{
