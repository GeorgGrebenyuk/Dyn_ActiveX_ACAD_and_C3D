namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadDatabasePreferences _i;
		internal AcadDatabasePreferences(object AcadDatabasePreferences_object) 
		{
			this._i = AcadDatabasePreferences_object as AXDBLib.IAcadDatabasePreferences;
		...
		///
		///</summary>
		public void Set_Lineweight(AXDBLib.AcLineWeight Path) 
		{
