...
namespace DynAXDBLib
{
    public class AcadApplication
    {
        ...
        {
            var check_app = Marshal.GetActiveObject(progID) as Autodesk.AutoCAD.Interop.IAcadApplication;
        ...
        {
            var check_app = Marshal.GetActiveObject("AutoCAD.Application") as Autodesk.AutoCAD.Interop.IAcadApplication;
            if (check_app != null) this._i = check_app;
        }
        ...
        public static Dictionary<string, string> AcadApplicationVersions() => new Dictionary<string, string>()
        {
            ...
            {"AutoCAD 2015","AutoCAD.Application.20.0"  },
            {"AutoCAD 2016","AutoCAD.Application.20.1"  },
            {"AutoCAD 2017","AutoCAD.Application.21.0"  },
            {"AutoCAD 2018","AutoCAD.Application.22.0"  },
            {"AutoCAD 2019","AutoCAD.Application.23.0"  },
