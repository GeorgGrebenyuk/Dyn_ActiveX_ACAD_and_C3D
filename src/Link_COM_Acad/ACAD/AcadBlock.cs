namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadBlock _i;
		internal AcadBlock(object AcadBlock_object) 
		{
			this._i = AcadBlock_object as AXDBLib.IAcadBlock;
		...
		///
		///</summary>
		public dynamic AddCustomObject(string ClassName) 
		{
			return this._i.AddCustomObject(ClassName);
		}
		...
		///
		///</summary>
		public dynamic AddAttribute(double Height,AXDBLib.AcAttributeMode Mode,string Prompt,object InsertionPoint,string Tag,string Value) 
		{
		...
		///
		///</summary>
		public dynamic AddLeader(object PointsArray,dynamic Annotation,AXDBLib.AcLeaderType Type) 
		{
		...
		///
		///</summary>
		public dynamic AddText(string TextString,object InsertionPoint,double Height) 
		{
			return this._i.AddText(TextString,InsertionPoint,Height);
		}
		...
		///
		///</summary>
		public dynamic InsertBlock(object InsertionPoint,string Name,double Xscale,double Yscale,double Zscale,double Rotation,object Password) 
		{
			return this._i.InsertBlock(InsertionPoint,Name,Xscale,Yscale,Zscale,Rotation,Password);
		}
		...
		///
		///</summary>
		public dynamic AddRaster(string imageFileName,object InsertionPoint,double ScaleFactor,double RotationAngle) 
		{
			return this._i.AddRaster(imageFileName,InsertionPoint,ScaleFactor,RotationAngle);
		}
		...
		///
		///</summary>
		public void Set_Units(AXDBLib.AcInsertUnits pIU) 
		{
			this._i.Units = pIU;
		}
		...
		///
		///</summary>
		public void Set_BlockScaling(AXDBLib.AcBlockScaling pBS) 
		{
