namespace DynAXDBLib 
{
	...
	public class AcadSecurityParams 
	{
		...
		///
		///</summary>
		public void Set_Action(int pOperations) 
		{
		...
		///
		///</summary>
		public int Action => this._i.Action;
		...
		///
		///</summary>
		public int ProviderType => this._i.ProviderType;
		...
		///
		///</summary>
		public int Algorithm => this._i.Algorithm;

		///<summary>
		///
		///</summary>
		public void Set_KeyLength(int pKeyLen) 
		{
		...
		///
		///</summary>
		public int KeyLength => this._i.KeyLength;
