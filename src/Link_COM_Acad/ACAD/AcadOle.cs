namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadOle _i;
		internal AcadOle(object AcadOle_object) 
		{
			this._i = AcadOle_object as AXDBLib.IAcadOle;
		...
		///
		///</summary>
		public void Set_OleItemType(AXDBLib.AcOleType pType) 
		{
		...
		///
		///</summary>
		public void Set_OlePlotQuality(AXDBLib.AcOlePlotQuality pPQuality) 
		{
