namespace DynAXDBLib 
{
    ...
    public class AcadMLeaderStyle 
	{
		...
		{
			this._i = AcadMLeaderStyle_object as Autodesk.AutoCAD.Interop.Common.AcadMLeaderStyle;
		...
		///
		///</summary>
		public void Set_DrawMLeaderOrderType(Autodesk.AutoCAD.Interop.Common.AcDrawMLeaderOrderType Type) 
		{
		...
		///
		///</summary>
		public void Set_DrawLeaderOrderType(Autodesk.AutoCAD.Interop.Common.AcDrawLeaderOrderType Type) 
		{
		...
		///
		///</summary>
		public void Set_FirstSegmentAngleConstraint(Autodesk.AutoCAD.Interop.Common.AcSegmentAngleType constraint) 
		{
		...
		///
		///</summary>
		public void Set_SecondSegmentAngleConstraint(Autodesk.AutoCAD.Interop.Common.AcSegmentAngleType constraint) 
		{
		...
		///
		///</summary>
		public void Set_LeaderLinetype(Autodesk.AutoCAD.Interop.Common.AcMLeaderType Type) 
		{
		...
		///
		///</summary>
		public void Set_LeaderLineWeight(Autodesk.AutoCAD.Interop.Common.AcLineWeight weight) 
		{
		...
		///
		///</summary>
		public void Set_TextAngleType(Autodesk.AutoCAD.Interop.Common.AcTextAngleType Type) 
		{
		...
		///
		///</summary>
		public void Set_TextAlignmentType(Autodesk.AutoCAD.Interop.Common.AcTextAlignmentType Type) 
		{
