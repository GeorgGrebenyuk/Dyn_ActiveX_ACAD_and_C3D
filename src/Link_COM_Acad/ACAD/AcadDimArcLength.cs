namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadDimArcLength _i;
		internal AcadDimArcLength(object AcadDimArcLength_object) 
		{
			this._i = AcadDimArcLength_object as AXDBLib.IAcadDimArcLength;
		...
		///
		///</summary>
		public void Set_SymbolPosition(AXDBLib.AcDimArcLengthSymbol Position) 
		{
