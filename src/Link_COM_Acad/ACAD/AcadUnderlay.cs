namespace DynAXDBLib 
{
	...
	{
		public AXDBLib.IAcadUnderlay _i;
		internal AcadUnderlay(object AcadUnderlay_object) 
		{
			this._i = AcadUnderlay_object as AXDBLib.IAcadUnderlay;
		...
		///
		///</summary>
		public void Set_UnderlayLayerOverrideApplied(AXDBLib.AcUnderlayLayerOverrideType bOverride) 
		{
