namespace DynAeccXLandLib 
{
	...
	{
		public AeccXLandLib.IAeccGraphStyle _i;
		internal AeccGraphStyle(object AeccGraphStyle_object) 
		{
			this._i = AeccGraphStyle_object as AeccXLandLib.IAeccGraphStyle;
		...
		///
		///</summary>
		public void Set_Direction(AeccXLandLib.AeccGraphDirectionType pVal) 
		{
